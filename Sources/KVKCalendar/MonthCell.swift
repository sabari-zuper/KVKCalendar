...
final class MonthCell: KVKCollectionViewCell {
    ...
    var events: [Event] = [] {
        didSet {
            ...
            if Platform.currentInterface == .phone && UIApplication.shared.orientation.isLandscape && !monthStyle.showEventsInIphone { return }
            ...
            for (idx, event) in items.enumerated() {
                ...
                if count > titlesCount {
                    ...
                    if (!event.isAllDay || Platform.currentInterface == .phone) && !monthStyle.showEventsInIphone {
        ...
        didSet {
            ...
            if !monthStyle.isHiddenSeparator {
                ...
                case .phone:
                    ...
                    if monthStyle.showEventsInIphone {
                        layer.borderWidth = monthStyle.widthSeparator
                        layer.borderColor = monthStyle.colorSeparator.cgColor
                    }
                    else if monthStyle.isHiddenSeparatorOnEmptyDate && day.type == .empty {
